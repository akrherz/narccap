"""
Generate the table 4 variable stflf
"""
import netCDF4
import datetime
import numpy
...
v = nc.createVariable("stflf", "f", ("yc", "xc"), fill_value=1e20)
v.units = "1"
v.standard_name = "land_area_fraction"
v.missing_value = numpy.array(1e20, v.dtype)
v.coordinates = "lon lat"
v.grid_mapping = "Lambert_Conformal"
v.long_name = "Land Area Fraction"
...
data = mm5.get_field("landmask", 0)["values"]
