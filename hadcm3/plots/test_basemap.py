...
ax3 = plt.axes([0.05,0.89,0.2,0.1], frameon=False, 
       axisbg=(0.4471,0.6235,0.8117), yticks=[], xticks=[])
ax3.imshow(logo, origin='lower')

cax.text(-0.5, 0.5, 'Temperature Difference [C]', transform=cax.transAxes,
...
ax.text(0.27, 1.08, "Soil Layer 4 Temperature [soil_t_4]\nScenario Avg (2066-2070) minus Contempory Avg (1996-2000)", transform=ax.transAxes,
     size=15, horizontalalignment='left', verticalalignment='center')

ax.text(0.01, -0.03, 'Plot Generated: %s' % (mx.DateTime.gmt().strftime("%d %b %Y %H%MZ"),), transform=ax.transAxes,
